  ...
  return (
    ...
    <Container>
      <Row className="justify-content-md-center">
        <Col className="container-main shadow">
          <div style={{ height: "100%", width: "100%", overflow: "auto" }}>


            {/* Home Page */}
            <div style={{ display: homePage ? "flex" : "none" }} className="flex-column justify-content-around align-items-center">
              <h1><i className="fab fa-creative-commons-sampling"></i> Recorder App</h1>
              <hr />

              <p>
                Wish to record videos from your web browser!!! Try this Recorder App which records either audio and video from device default camera and mic or capture screen (without audio) and you can download the recorded media in mp4 file. Give it a try!!!
              </p>

              <button className="button button--fenrir" onClick={() => { setHomePage(false); setRecPage(true); startSystem(); }}>
              ...
              <h6 className="mb-5">Check your browser compatibility by <a className="link" href="https://developer.mozilla.org/en-US/docs/Web/API/Media_Streams_API#browser_compatibility" target="_blank">clicking here <i className="fas fa-external-link-alt"></i></a></h6>
              ...
              <Container className="rounded border-white border p-4 bg-light text-dark shadow">
                <Row >
                  <Col className="d-flex justify-content-center border-bottom mb-2">
                    <h3><i className="fas fa-cogs"></i> Settings</h3>
                  </Col>
                </Row>
                <Row className="my-2">
                ...
                <Row className="mt-2">
                  <Col className="d-flex justify-content-center">
                    <h4><i className="fas fa-microphone-alt"></i> Audio Recording</h4>
                  </Col>
                  <Col className="d-flex justify-content-center">
                    <Button variant="outline-primary" onClick={() => setConstraintObj({ audio: !constraintObj.audio, video: constraintObj.video, })} disabled={!frontCamRec} >{constraintObj.audio ? <i className="fas fa-toggle-on"></i> : <i className="fas fa-toggle-off"></i>}</Button>
                  </Col>
                </Row>
                <Row>
            ...
            {/* Recording Page */}
            <div className="flex-column justify-content-around" style={{ display: recPage ? "flex" : "none" }}>
              <video ref={videoRef} controls muted />
              <div className="d-flex justify-content-around align-items-center">
                <button className="button button--anthe" ref={startRecRef} style={{ display: !isRecording ? "inline-block" : "none", marginTop: "55px" }}><span><i className="fas fa-play"></i> Start Recording</span></button>
                <button className="button button--rhea" ref={stopRecRef} style={{ display: isRecording ? "inline-block" : "none" }}><span style={{ color: "black" }}><i className="fas fa-stop"></i> Stop Recording</span></button>
              </div>
            </div>

            {/* Download Page */}
            <div className="flex-column justify-content-around" style={{ display: downPage ? "flex" : "none" }}>
              <video ref={downloadRef} controls />
              <div className="d-flex justify-content-around align-items-center">
                <a target="_blank" download href={downloadLink} onClick={() => notify("Download Started")}>
                  <button className="button button--bestia">
                    <div className="button__bg"></div><span><i className="fas fa-download"></i> Download</span>
                  </button>
                </a>

                <button className="button button--fenrir" onClick={() => { setDownPage(false); setHomePage(true); downloadRef.current.pause() }}>
                  <svg aria-hidden="true" className="progress" width="70" height="70" viewBox="0 0 70 70">
                    <path className="progress__circle" d="m35,2.5c17.955803,0 32.5,14.544199 32.5,32.5c0,17.955803 -14.544197,32.5 -32.5,32.5c-17.955803,0 -32.5,-14.544197 -32.5,-32.5c0,-17.955801 14.544197,-32.5 32.5,-32.5z" />
                    <path className="progress__path" d="m35,2.5c17.955803,0 32.5,14.544199 32.5,32.5c0,17.955803 -14.544197,32.5 -32.5,32.5c-17.955803,0 -32.5,-14.544197 -32.5,-32.5c0,-17.955801 14.544197,-32.5 32.5,-32.5z" pathLength="1" />
                  </svg>
